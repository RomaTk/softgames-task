...
export type TDefaultStaticFunctions = TStaticFunctions<
	ReturnType<typeof createViewObject>,
	ReturnType<typeof createAuthorName>,
	ReturnType<typeof createMessageText>,
...
export const getGrouppedStaticFunctions = (
	precisedSizeHelper: TPreciseSizeHelper<HTMLText>,
): TDefaultStaticFunctions => ({
	create: {
